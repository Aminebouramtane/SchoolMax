...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('students.students') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('students.add_students') }}</span>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-body">
								<div class="main-content-label mg-b-5">
									{{ trans('students.add_students') }} :
								</div>
								<form action="{{route("students.store")}}" method="POST" enctype="multipart/form-data" class="parsley-style-1" id="selectForm2" name="selectForm2">
									@csrf
									<div class="">
										...
										<div class="row mg-b-20">
											<div class="parsley-input col-md-6" id="fnWrapper">
												...
												<input class="form-control" data-parsley-class-handler="#fnWrapper" name="student_name_en" placeholder="Enter name en" required="" type="text">
											</div>
											<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
												<label>{{ trans('students.name_en') }}:</label>
												<input class="form-control" data-parsley-class-handler="#lnWrapper" name="student_name_ar" placeholder="Enter name ar" required="" type="text">
											</div>
										</div>
										<div class="row mg-b-20">
											<div class="parsley-input col-md-6" id="fnWrapper">
												<label>{{ trans('students.email') }} :</label>
												<input class="form-control" data-parsley-class-handler="#fnWrapper" name="email" placeholder="Enter Email" required="" type="email">
											</div>
											<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
												<label>{{ trans('students.password') }} :</label>
												<input class="form-control" data-parsley-class-handler="#lnWrapper" name="password" placeholder="Enter Password" required="" type="password">
											</div>
										</div>
										<div class="row mg-b-20">
										...
										<div class="row mg-b-20">
											<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
												...
												<input class="form-control" data-parsley-class-handler="#lnWrapper" name="birthday" placeholder="day-mount-year" required="" type="date">
											</div>
											<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
												<label>{{ trans('parents.Phone_Father') }} :</label>
												<input class="form-control" data-parsley-class-handler="#lnWrapper" name="phone" placeholder="+21 2* ** ** **" required="" type="text">
											</div>
										</div>
										<div class="row mg-b-20">
											<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
												<label>{{ trans('parents.Address_Father_en') }} :</label>
												<input class="form-control" data-parsley-class-handler="#lnWrapper" name="adress_en" placeholder="Enter Adress en" required="" type="text">
											</div>
											<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
												<label>{{ trans('parents.Address_Father') }} :</label>
												<input class="form-control" data-parsley-class-handler="#lnWrapper" name="adress_ar" placeholder="Enter Adress ar" required="" type="text">
											</div>
										</div>
										<div class="row mg-b-20">
											<div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
												<label>{{ trans('parents.cin') }} :</label>
												<input class="form-control" data-parsley-class-handler="#lnWrapper" name="cin" placeholder="Enter CIN" required="" type="text">
											</div>
