							...
							<div class="card-body">
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
										...
										<tbody>
											<?php $e=0 ?>
											@foreach ($PrcFees as $proc)
											<?php $e++ ?>
											<tr>
												<td>{{ $e }}</td>
												<td>{{App::getLocale() == 'en'?$proc->student->student_name_en:$proc->student->student_name_ar}}</td>
												<td>{{ number_format($proc->amount, 2) }}</td>
												<td>{{$proc->description}}</td>
												<td>
													<button type="button" class="btn btn-info btn-sm" data-target="#edit{{$proc->id}}" data-toggle="modal"><i class="fa fa-edit"></i>
													</button>
													<button type="button" class="btn btn-danger btn-sm" data-target="#delete{{$proc->id}}" data-toggle="modal"><i class="fa fa-trash"></i>
													</button>
												</td>
											</tr>
											{{-- DELETE_modal_Grade --}}
											<div class="modal fade" id="delete{{$proc->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															{{-- add_form --}}
															<form action="{{route("processing_fees.destroy",$proc->id)}}" method="post">
																@method("DELETE")
																@csrf
																<div class="row">
																	<div class="col">
																...
																<div class="modal fade" id="edit{{$proc->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
																aria-hidden="true">
																<div class="modal-dialog modal-lg">
																	<div class="modal-content">
																		...
																		<div class="modal-body">
																			...
																			<form class=" row mb-30" action="{{route("processing_fees.update",$proc->id)}}" method="POST">
																				@method("PUT")
																				@csrf
																				<div class="card-body">
																					<div class="repeater">
																							...
																							<div data-repeater-item>
																								<div class="row">
																									<div class="parsley-input col-md-6" id="fnWrapper">
																										...
																										<input class="form-control" data-parsley-class-handler="#fnWrapper" value="{{$proc->amount}}" name="debit" required="" type="text">
																								...
																								<div class="form-group">
																									...
																									<textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3" >{{$proc->description}}</textarea>
																								</div>
																							</div>
																						</div><br>
																						<div class="modal-footer">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form class=" row mb-30" action="{{route("processing_fees.store")}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="repeater">
                                            <div data-repeater-list="List_Classes">
