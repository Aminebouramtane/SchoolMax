...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('sidebar_trans.Dashboard') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('dashboards.my_children') }}</span>
						</div>
					</div>
					...
					<table id="example" class="table key-buttons text-md-nowrap">
						<thead>
							<tr>
								...
								<th class="border-bottom-0">{{ trans('questions.score') }}</th>
							</tr>
						</thead>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{route("mychildren.show",$Student->id)}}" class="btn btn-sm btn-info"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-ol" viewBox="0 0 16 16">
