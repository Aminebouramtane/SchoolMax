...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{ trans('exams.exam') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('questions.list_questions') }}</span>
						</div>
					</div>
						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-0">{{ trans('questions.type_question') }} :<span style="color:red;">{{App::getLocale()=='en'?$Exams->exam_name_en:$Exams->exam_name_ar}}</span></h4>
								</div>
							</div>
							<div class="card-body">
												...
												<div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class=" row mb-30" action="{{route("question.update",$question->id)}}" method="POST">
                                                                    @csrf
                                                                    @method("PUT")
                                                                    <div class="card-body">
                                                                        <div class="repeater">
                                                                            <div data-repeater-list="List_Classes">
                                                                                <div data-repeater-item>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <input type="hidden" value="{{$Exams->id}}" name="exam_id" id="">
                                                                                        <div class="col">
		...
		<!-- main-content closed -->
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class=" row mb-30" action="{{route("question.store")}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="repeater">
                                            <div data-repeater-list="List_Classes">
                                                <div data-repeater-item>
													<div class="row">
														...
														<div class="parsley-input col-md-12" id="fnWrapper">
															<label>{{ trans('questions.answers') }}:</label>
															<input class="form-control" data-parsley-class-handler="#fnWrapper" name="answers" placeholder="{{trans('questions.wright_answer')}}" required="" type="text"><br>
														</div><br>
														<div class="parsley-input col-md-12" id="fnWrapper">
															<label>{{ trans('questions.r_answers') }}:</label>
