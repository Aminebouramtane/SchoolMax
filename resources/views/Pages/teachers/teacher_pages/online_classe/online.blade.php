									...
									<table class="table text-md-nowrap" id="example1">
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td>{{App::getLocale()=='en'? Auth::guard('teacher')->user()->teacher_name_en:Auth::guard('teacher')->user()->teacher_name_ar }}</td>
                                                <td>{{$online_classe->topic}}</td>
                                                <td>{{$online_classe->start_at}}</td>
                                                <td>{{$online_classe->duration}}</td>
                                                <td class="text-danger"><a href="{{$online_classe->join_url}}" target="_blank">{{ trans('online_classes.join') }}</a></td>
												<td>
													{{-- <button type="button" class="btn btn-info btn-sm" data-target="#edit{{$online_classe->id}}" data-toggle="modal"><i class="fa fa-edit"></i>
													</button> --}}
												...
												<div class="modal-dialog" role="document">
													<div class="modal-content">
														...
														<div class="modal-body">
															{{-- add_form --}}
															<form action="{{route("online.destroy",$online_classe->id)}}" method="post">
																@method("DELETE")
																@csrf
																<div class="row">
																	<div class="col">
		...
		<!-- main-content closed -->
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class=" row mb-30" action="{{route("online.store")}}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="repeater">
