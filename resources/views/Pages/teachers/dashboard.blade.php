...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
                    <h3>{{ trans('dashboards.Welcom') }} {{App::getLocale()=='en'?auth()->user()->teacher_name_en:auth()->user()->teacher_name_ar}}</h3>
				</div>
				<!-- /breadcrumb -->
@endsection
@section('content')
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">{{$count_students}}</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white"></h4>
											<p class="mb-0 tx-12 text-white op-7">{{$count_sections}}</p>
										</div>
                        ...
                        <div class="card">
                            <div class="card-header pb-0">
                                <div class="d-flex justify-content-between">
                                    <h4 class="card-title mg-b-0">{{ trans('dashboards.my_students') }}</h4>
                                </div>
                            </div>
                            <div class="card-body">
